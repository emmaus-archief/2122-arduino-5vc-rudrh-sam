...
int positieRandom2[6] = {16, 20, 24, 28, 32, 36};
...
int randomPosities (int positieObjectX) {
    ...
    if (positieRandom[x] > 0) {positieObjectX = positieRandom[x];
    };
    positieRandom[x] = 0;
    if (positieRandom[0] == 0 &
        positieRandom[1] == 0 &
        positieRandom[2] == 0 &
        positieRandom[3] == 0 &
        positieRandom[4] == 0 &
        positieRandom[5] == 0) {positieRandom = positieRandom2;}
