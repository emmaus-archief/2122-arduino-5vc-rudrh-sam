...
void positieObjecten (int positieObject) {
    if (positieObject < 0) {
    positieObject = 39;}
  }

void positieObjecten (int positieObject1, int positieObject2, int positieObject3, int positieObject4, int positieObject5) {if (positieObject1 < 0 & (positieObject2 > 0 || positieObject3 > 0 || positieObject4 > 0 || positieObject5 > 0)) {
    positieObject1 = 35;
...
void knopStatussen (int knopKleur, int ledStatusKleur, int ledKleur) {if (knopStatus == uitKnopLos) {
...
if(gameModeStatus == EASY || gameModeStatus == NORMAL) {
  ...
  positieObjecten(positieVierkantX);
  positieObjecten(positieGroteRechthoekX);
  positieObjecten(positieDriehoekX);
  positieObjecten(positieRechthoekX);
...
// knopStatussen (knopGeel, ledStatusGeel, ledGeel);
// knopStatussen (knopGroen, ledStatusGroen, ledGroen);
// knopStatussen (knopRood, ledStatusRood, ledRood);
// knopStatussen (knopBlauw, ledStatusBlauw, ledBlauw);
