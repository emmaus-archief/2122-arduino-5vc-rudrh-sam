...
/*
int positieObjecten (int positieObject1, int positieObject2, int positieObject3, int positieObject4, int positieObject5) {if (positieObject1 < 0 & (positieObject2 > 0 || positieObject3 > 0 || positieObject4 > 0 || positieObject5 > 0)) {
    positieObject1 = 35;
  } else if(positieObject1 < 0){
    positieObject1 = positieRandom[random(6)];
    positieObject2 = positieRandom[random(6)];
    positieObject3 = positieRandom[random(6)];
    positieObject4 = positieRandom[random(6)];
    positieObject5 = positieRandom[random(6)];
  }};*/
...
Serial.println(positieVierkantX);
  ...
  if(gameStatus == SPELEN || gameStatus == OBSTAKEL) {
    ...
    if (tijd > tijdNu + 500 & (positieRechthoekX < 17 || positieVierkantX < 23 || positieGroteRechthoekX < 29 || positieDriehoekX < 35  || positieVijandX < 41) & (gameModeStatus == EASY)){
    ...
    if (tijd > tijdNu + 350 & (positieRechthoekX < 17 || positieVierkantX < 23 || positieGroteRechthoekX < 29 || positieDriehoekX < 35  || positieVijandX < 41) & (gameModeStatus == NORMAL)) {
       positieRechthoekX  = positieRechthoekX - 1;
    positieVierkantX = positieVierkantX - 1;
    positieGroteRechthoekX = positieGroteRechthoekX - 1;
    positieDriehoekX = positieDriehoekX - 1;
...
if(gameModeStatus == HARD) {
   positieObjecten(positieVierkantX, positieGroteRechthoekX, positieDriehoekX, positieRechthoekX, positieVijandX);
   positieObjecten(positieGroteRechthoekX, positieVierkantX, positieDriehoekX, positieRechthoekX, positieVijandX);
   positieObjecten(positieDriehoekX, positieVierkantX, positieGroteRechthoekX, positieRechthoekX, positieVijandX);
   positieObjecten(positieRechthoekX, positieVierkantX, positieGroteRechthoekX, positieDriehoekX, positieVijandX);
   positieObjecten(positieVijandX, positieVierkantX, positieGroteRechthoekX, positieDriehoekX, positieRechthoekX);
} 
...
int ledFunctieGeel 
 ...
 knopGeel, ledStatusGeel, ledGeel = knopStatussen(knopGeel, ledStatusGeel, ledGeel);
 knopGroen, ledStatusGroen, ledGroen = knopStatussen (knopGroen, ledStatusGroen, ledGroen);
 knopRood, ledStatusRood, ledRood = knopStatussen (knopRood, ledStatusRood, ledRood);
 knopBlauw, ledStatusBlauw, ledBlauw = knopStatussen (knopBlauw, ledStatusBlauw, ledBlauw);
